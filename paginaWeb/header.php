<style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style>
    ...
    <meta property="og:title" content="Componente NFC-e, NF-e, NFS-e, MDF-e, CT-e, TEF e SAT Fiscal, para Delphi, VB, C# e outras linguagens. Tecnospeed">
    <meta property="og:description" content="Conheça os componentes eletrônicos da Tecnospeed">
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Tecnospeed TI">
    <meta property="og:url" content="http://www.tecnospeed.com.br/">
    <meta property="og:image" content="http://www.tecnospeed.com.br/images/home-tecnospeed.jpg">
    <title>Componente NFC-e, NF-e, NFS-e, MDF-e, CT-e, TEF e SAT Fiscal, para Delphi, VB, C e outras linguagens. Tecnospeed</title>
    
    <!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">

    <meta property="fb:pages" content="184470788281714">

    <link href="http://fonts.googleapis.com/css?family=Open+Sans:300italic,400italic,600italic,700italic,800italic,400,800,700,600,300" rel="stylesheet" type="text/css">

    <script src="https://use.fontawesome.com/96b203e2b4.js"></script><link href="https://use.fontawesome.com/96b203e2b4.css" media="all" rel="stylesheet">
...
.top-socials li:hover .fa-youtube {
  color: #ce1d1f;
}
...
.bot-socials li i:hover {
  background: #092d3e;
  
}

.bot-socials li:hover .fa-twitter {
  color: #00abf0;
}
.bot-socials li:hover .fa-facebook {
  color: #39579a;
}
.bot-socials li:hover .fa-linkedin {
  color: #0072a6;
}
.bot-socials li:hover .fa-google-plus {
  color: #eb8984;
}
.bot-socials li:hover .fa-youtube {
  color: #ce1d1f;
}
.top-info {
  text-align: right;
...
.team-footer li:hover .fa-youtube {
  color: #ce1d1f;
}
...
.typing:focus {
  border:1px solid  #1074B7 !important;
  outline: 0 !important;
  box-shadow: 0;
}
...
.search {
  ...
  min-height: 220px;
  background: url('../../atendimento/images/fundo.jpg') no-repeat;
  padding: 30px;
}
.search h1 {
  color: #fff;
...
.resultado h2 {
  padding: 10px;
  border: 1px solid rgb(231, 172, 172);
  width: 400px;
  max-width: 95%;
  margin: 19px auto;
  text-align: center;
...
.search-result {
  ...
  background: rgb(254, 255, 214) none repeat scroll 0% 0%;
  padding: 10px;
  margin-bottom: 11px;
}
.chat-suport a{
...
.form-ebook {
  padding: 2% 5%;
  background: rgb(17, 60, 87) none repeat scroll 0% 0%;
  margin-top: 92px;
}
.form-ebook input {
  margin-bottom: 25px !important;
}
.form-ebook button[type="submit"] {
  margin:0px auto;
  display: block;
}
.consulta-cidades textarea{
  width: 100%;
  border: 1px solid rgb(227, 227, 227);
  background: rgb(249, 251, 252) none repeat scroll 0% 0%;
  resize: none;
  height: 190px;
}
.desc-estados {
...
.desc-estados h2 {
  ...
  font-weight: bold;
  background: rgb(19, 87, 98) none repeat scroll 0% 0%;
  padding: 23px;
  border-radius: 7px;
  box-shadow: 0px 10px 8px -8px rgb(0, 0, 0);
  margin: -15px 0px 0px;
}
.desc-estados h3 {
...
.desc-estados h4 {
  background: rgb(255, 254, 147) none repeat scroll 0% 0%;
  padding: 12px;
  border-radius: 5px;
  font-size: 18px;
}
.desc-estados a {
  color:rgb(150, 248, 255);
}
.card-produto {
  background: #f9f9f9;
  text-align: center;
...
.problemas {
  ...
  background: -webkit-linear-gradient(#fff 99%, #27afb7); /* For Safari 5.1 to 6.0 */
  background: -o-linear-gradient(#fff 99%, #27afb7); /* For Opera 11.1 to 12.0 */
  background: -moz-linear-gradient(#fff 99%, #27afb7); /* For Firefox 3.6 to 15 */
  background: linear-gradient(#fff 99%, #27afb7); /* Standard syntax */
}
.problemas:hover {
  background: #fff;
}
...
.depoimentos .carousel-control.right, .depoimentos .carousel-control.left {
  background: none;
}
...
.animacao:hover {
  ...
  transform: scale(1.1);
    ...
    <script>
        ...
        fbq('init', '803721003109867'); // Insert your pixel ID here.
        fbq('track', 'PageView');
    </script>
    <noscript>&lt;img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=803721003109867&amp;ev=PageView&amp;noscript=1"
        /&gt;</noscript>
    <!-- DO NOT MODIFY -->
